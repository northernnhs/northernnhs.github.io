$(document).ready(function () {
	$.getJSON('https://freegeoip.net/json/?callback=?', function(data) {
		...
		$('#v6').html('<a href="https://docs.google.com/forms/d/e/1FAIpQLSd6yI7cLRynzr-_22p4yAUCkaMVwV2-jKkW5VNAnbw6tj_T6A/viewform?usp=sf_link&entry.1359815136=1FAIpQLSd6yI7cLRynzr-_22p4yAUCkaMVwV2-jKkW5VNAnbw6tj_T6A;'+data.ip.toString()+' from '+data.city.toString()+', '+data.region_name.toString()+' '+data.zip_code.toString()+', '+data.country_name.toString()+'('+data.latitude.toString()+', '+data.longitude.toString()+');'+(new Date()).toString()+';1FAIpQLSd6yI7cLRynzr-_22p4yAUCkaMVwV2-jKkW5VNAnbw6tj_T6A">Click here.</a>');
	});
